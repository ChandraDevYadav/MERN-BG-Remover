    ...
    return (
        <div className='pb-16'>
            ...
            <div className='text-center mb-24'>
                ...
                <label className='inline-flex gap-3 px-8 py-3.5 rounded-full cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-600 m-auto hover:scale-105 transition-all duration-700' htmlFor="upload2">
